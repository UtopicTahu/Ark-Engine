...
cvar_t	fps_max = {"fps_max", "72", CVAR_ARCHIVE}; //johnfitz
...
{
	if (var->value > 72)
		Con_Warning ("fps_max above 72 breaks physics.\n");
}
...
void Host_InitLocal (void)
{
	...
	Cvar_RegisterVariable (&fps_max); //johnfitz
	Cvar_SetCallback (&fps_max, Max_Fps_f);
...
qboolean Host_FilterTime (float time)
{
	...
	maxfps = CLAMP (10.f, fps_max.value, 1000.f);
